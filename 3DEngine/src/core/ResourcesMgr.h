...
template <class... Types>
static std::shared_ptr<Texture> ResourcesMgr::texture(const std::string& path, Types&&... args)
{
...
template <class ComponentType>
static std::shared_ptr<ComponentType> ResourcesMgr::getComponent(const std::string& key)
{
...
template <class ComponentType, class... Types>
static std::shared_ptr<ComponentType> ResourcesMgr::createComponent(const std::string& key, Types&&... args)
{
    if (m_components.count(key))
    {
